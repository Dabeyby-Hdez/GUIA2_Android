...
public class ActivitySegunda extends AppCompatActivity implements View.OnLongClickListener {
    AutoCompleteTextView fruta, animal, lenguaje;
    Button btprocesar;
    String[] frut = { "Uvas","Manzana","Sandia" };
    String[] lengua = { "C","JAVA","C#" };
    String[] anima = { "Koala","Ballena","Delfin" };
    ProgressBar bara;
